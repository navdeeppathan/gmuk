    ...
    <nav id="navbar" class="fixed w-full z-50 transition-all duration-300 {{ $isGallary ? 'bg-[#008543]' : 'bg-transparent' }}">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="flex-shrink-0 flex items-center gap-3 cursor-pointer" onclick="window.scrollTo(0,0)">
                    {{-- <div class="w-12 h-12 bg-[ linear-gradient(358deg, var(--light-gold), var(--gold), var(--gold-d));] rounded-full flex items-center justify-center">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    <div class="relative">
                        <!-- Profile Button -->
                        <button id="profileBtn" class="flex items-center gap-2 text-white bg-[linear-gradient(358deg, var(--light-gold), var(--gold), var(--gold-d));] px-4 py-2 rounded-full font-semibold text-sm hover:bg-[#F4E8C1] transition">
                    ...
                    @endauth --}}
                    <a href="/#donate" class="btn-premium bg-[ linear-gradient(358deg, var(--light-gold), var(--gold), var(--gold-d));] text-[#008543] px-6 py-2.5 rounded-full font-semibold text-sm hover:bg-[#F4E8C1] transition-colors">
                        Donate Now
                    </a>
                </div>
        ...
        <div id="mobile-menu" class="mobile-menu fixed top-0 right-0 w-80 h-full bg-[#008543] shadow-2xl md:hidden z-50 p-8">
            ...
            <div class="mt-16 space-y-6">
                ...
                <a href="#donate" class="block bg-[ linear-gradient(358deg, var(--light-gold), var(--gold), var(--gold-d));] text-[#008543] px-6 py-3 rounded-full font-semibold text-center mt-8">Donate Now</a>
            </div>
        </div>
    </nav>
