    ...
    <footer class="bg-[#0F2E26] text-white py-16 border-t border-[#D4AF37]/20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                <div class="col-span-1 md:col-span-2">
                    ...
                    <div class="flex gap-4">
                        <a href="#" class="text-gray-400 hover:text-[#D4AF37] transition-colors">Privacy Policy</a>
                        <a href="#" class="text-gray-400 hover:text-[#D4AF37] transition-colors">Terms of Service</a>
                        <a href="#" class="text-gray-400 hover:text-[#D4AF37] transition-colors">GDPR</a>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        ...
                        <li><a href="#impact" class="text-gray-400 hover:text-white transition-colors">Our Impact</a></li>
            ...
            <div class="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                <p class="text-gray-500 text-sm">© 2026 Gujrat Muslim Association UK. All rights reserved.</p>
                <p class="text-gray-500 text-sm">Registered Charity No: XXXXXX</p>
            </div>
        </div>
    </footer>