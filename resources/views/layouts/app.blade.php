...
<head>
    ...
    <style>
        ...
        ::-webkit-scrollbar-thumb { background: var(--deep-green); border-radius: 5px; }
        ...
        /* Gold Gradient Text (legacy alias) */
        .text-gold-gradient {
            background: linear-gradient(358deg, #F4E8C1, #C9A84C, #8B6914);
            -webkit-background-clip: text;
            -webkit-text-fill-color: transparent;
        ...
        /* =============================================
           NAVBAR GOLD DIVIDER LINE
        ============================================= */
        .nav-gold-line {
            height: 3px;
            background: linear-gradient(90deg, transparent, #F4E8C1, #C9A84C, #8B6914, transparent);
            opacity: 0;
...
<body class="antialiased text-gray-800">
    ...
    <div id="loader">
        <div class="text-center">
            ...
            <p class="text-white font-serif text-xl">The Gujarat Muslim Association UK</p>
            <p class="gold-text text-sm mt-2 font-semibold">Since 1968</p>
        </div>
    </div>
    ...
    <script>
        const isDashboard = {{ request()->is('dashboard*') ? 'true' : 'false' }}
            || {{ request()->is('gallery-page*') ? 'true' : 'false' }}
            || {{ request()->is('gallery-detail*') ? 'true' : 'false' }}
            || {{ request()->is('about-page*') ? 'true' : 'false' }};
    </script>
    ...
    <script>
        ...
        window.addEventListener('scroll', () => {
            ...
            if (currentScroll > 100) {
                navbar.classList.add('glass-dark', 'shadow-lg', 'navbar-scrolled');
                navbar.classList.remove('bg-transparent');
            } else {
                navbar.classList.remove('glass-dark', 'shadow-lg', 'navbar-scrolled');
