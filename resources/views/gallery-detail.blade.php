...
<section class="py-24 bg-[#FDF8F3] min-h-screen">
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <!-- Back Button -->
        <div class="mb-10">
            <a href="{{ route('gallery.index') }}" class="text-[#1B4D3E] font-semibold hover:text-[#D4AF37] transition">
                ← Back to Gallery
            </a>
        </div>
        ...
        <div class="text-center mb-16">
            ...
            <h1 class="font-serif text-4xl md:text-5xl text-[#0F2E26] font-bold mb-6">
                {{ $gallery->title }}
            </h1>
        ...
        <!-- Related Images -->
        <div>
            <h3 class="font-serif text-3xl text-[#0F2E26] font-bold mb-10 text-center">
                ...
                @foreach($related as $item)
                    <a href="{{ route('gallery.detail', $item->id) }}" 
                       class="group relative overflow-hidden rounded-2xl">
                        ...
                        <div class="absolute inset-0 bg-[#0F2E26]/60 opacity-0 group-hover:opacity-100 transition flex items-center justify-center">
